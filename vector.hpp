...
namespace ft{
	...
	template< typename L>class random_access_iterator
		...
		template<typename A, typename B>
			friend bool operator==(const vector::template random_access_iterator<A> & lhs, const vector::template random_access_iterator<B> & rhs){
				return &(*lhs) == &(*rhs);
			...
			template<typename A, typename B>
			friend typename vector::template random_access_iterator<A>::difference_type operator-(const vector::template random_access_iterator<A> & lhs, const vector::template random_access_iterator<B> & rhs){
				return &(*lhs) - &(*rhs);
			}
			...
			template<typename L>
			friend vector::template random_access_iterator<L> operator +(const typename vector::template random_access_iterator<L>::difference_type & a, const vector::template random_access_iterator<L> & iter){
				return	(a + iter);
			}
